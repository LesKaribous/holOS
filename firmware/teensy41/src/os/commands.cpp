...
FLASHMEM void registerCommands() {
    ...
    CommandHandler::registerCommand("test_sync_vision()", "Diag: go (1000,1000), syncToVision, go (1000,1000) — should land on target if vision sync works", command_test_sync_vision);
