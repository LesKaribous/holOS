...
let _calibDirty = {};
let _calibData  = {
  cx: 1.211321, cy: -1.211321, cr: 0.831,
...
function stallPushParams() {
  const params = [
    ...
    { id: 'stall-stag-move-mm',  key: 'stall.stag_move_mm'  },
    { id: 'stall-stag-time',     key: 'stall.stag_time'     },
    { id: 'stall-stag-error-mm', key: 'stall.stag_error_mm' },
